...
#### [Script-InQuote] (Alias: qscr) - Apply the script only to strings enclosed in quotes.<a id="Script-InQuote"></a>

[Script-InQuote]: src/Script-InQuote_function.ps1
