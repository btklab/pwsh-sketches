...
function addt {
    ...
    [CmdletBinding()]
    Param (
        # The text to prepend to the beginning of the entire output.
    ...
    # The 'begin' block is executed only once, before any pipeline input is processed.
    # This is the perfect place to prepend our text, ensuring it appears at the very top of the output.
    begin {
